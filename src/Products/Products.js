...
function Product() {
  ...
  return (
    <div className="container-fluid">
      <section className="row banner banner_products py-5 d-flex align-items-center">
        <div className="banner_content pl-3 pl-md-5 font-weight-bold col-6 mx-auto text-center">
          ...
          <h1 className="display-4  banner_text font_sans_pro">our products</h1>
        </div>
      </section>

      <section className="features pl-4 mt-5 font_sans_pro">
        <div className=" px-1 px-md-1">
          <div className="row my-5">
            <aside className="col-3 col-md-3">
              ...
              <section className="byprice mt-5">
                <h4 className="title_style">shop by price</h4>
                <strong className="d-block my-3">range:$0-$1000</strong>
                <form action="#">
              ...
              <section className="bycolor my-5">
                <h3 className="title_style">shoping by color</h3>
                <div className="colors">
                  <div className="color_item my-3">
                    <span className="box_color box_color--red"></span>
                    <span className="number_of_color">red(5)</span>
                  </div>
                </div>
                <div className="colors">
                  <div className="color_item my-3">
                    <span className="box_color box_color--black"></span>
                    <span className="number_of_color">black(3)</span>
                  </div>
                </div>
                <div className="colors">
                  <div className="color_item my-3">
                    <span className="box_color box_color--blue"></span>
                    <span className="number_of_color">blue(5)</span>
                  </div>
                </div>
                <div className="colors">
                  <div className="color_item my-3">
                    <span className="box_color box_color--green"></span>
                    <span className="number_of_color">greev(8)</span>
                  </div>
                </div>
              </section>
            </aside>
